...
{!loading && !error && ebooks.length === 0 && (
  ...
  >
    {/* icon */}
    <div className="mx-auto mb-4 flex h-16 w-16 items-center justify-center rounded-full bg-[#f6f1ea]">
      <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8 text-[#AE7C54]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    <p className="mx-auto mt-2 max-w-xl text-sm leading-6 text-[#053c41]/70">
      {genre !== "all"
        ? `We don't have any ${genre} ebooks right now. Try browsing a different genre or check back soon — new books are added regularly.`
        : search
        ? `We couldn't find any ebooks matching "${search}". Try different keywords or browse by genre.`
        : "We could not find any ebooks for your current filters. Try adjusting your search, price range, or availability."}
    </p>
